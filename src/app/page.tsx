...
export default function Home() {
  const getDateDiff = (d1: string, d2: string) => {
    ...
    if (d1 !== "" && pattern.test(d1)) {
      ...
      return dateDiff.includes(".")
        ? dateDiff.split(".")[0] +
        (dateDiff.split(".")[0] === "0" || dateDiff.split(".")[0] === "1"
          ? "y "
          : "ys ") +
        dateDiff.split(".")[1] +
        "m"
  ...
  return (
    <main className="pt-16 pb-8 px-5 w-full flex justify-center leading-normal tracking-wide text-l-2">
      <div
        style={{ maxWidth: layout.width ? layout.width : 794 }}
        className="w-full"
      >
        {/* Title */}
          ...
          <div>
            ...
            <div className="px-6 py-5 mt-3 rounded-lg border-2 border-h-main/50 bg-h-main/10">
              <div className="group relative flex items-center gap-2 text-l-5">
                ...
                <Link
                  href="https://github.com/codingfarhan"
                  target="_blank"
                  className="group text-h-main"
                >
                  <span className="rounded-md border-2 border-transparent group-hover:border-h-main duration-200">
                    https://github.com/codingfarhan
                  </span>
              ...
              <div className="group mt-1.5 relative flex items-center gap-2 text-l-5">
                ...
                <Link
                  href="https://www.linkedin.com/in/farhans-profile/"
                  target="_blank"
                  className="group text-h-main"
                >
                  <span className="rounded-md border-2 border-transparent group-hover:border-h-main duration-200">
                    https://www.linkedin.com/in/farhans-profile/
                  </span>
                  <i className="fa-solid fa-link ml-1 text-xs"></i>
                </Link>
              </div>
        ...
        <section className="mt-8">
          ...
          <p>
            With 3+ years of experience, I specialize in crafting scalable
            software solutions across web2, web3, and AI domains. At Willow, I am
            building Will - an AI agent simplifying social media management for
            businesses. As a Full-Stack Blockchain Engineer at Add3, I designed
            and scaled a B2B DeFi app, powering $65M+ in TVL and thousands of
            daily staking transactions. My technical expertise spans React.js,
            Node.js, NestJS, and Solidity, delivering innovative tools for smart
            contract deployment, token sales, and liquidity pools.
            <br />
            <br />
            Beyond engineering, I am passionate about open source, contributing
            to projects like Thirdweb SDK and CopilotKit AI SDK, enhancing user
            experiences for over 100k developers. Coming from an Economics
            background, I merge analytical thinking with technical prowess to
          ...
          <div className="w-full mt-12 flex flex-col gap-5">
              ...
              <div className="w-full lg:w-[30%] shrink-0 flex flex-col gap-4">
                <h3 className="w-fit text-lg pl-2 pr-5 font-medium flex items-center rounded-full border-2 border-h-main/50 bg-h-main/10 text-h-main">
                  <div className="w-10 h-10 flex justify-center items-center">
                    <svg
                      className="w-5 h-5 fill-h-main"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 384 512"
                    >
                      <path
                        d="M64 48c-8.8 0-16 7.2-16 16V448c0 8.8 7.2 16 16 16h80V400c0-26.5 
            ...
            7.2-16 16-16z"
              ...
              <div className="w-full">
                <h3 className="text-lg font-medium">
                  Built and maintained an AI Agent (Will) for social media
                  management.
                </h3>
                <ul className="mt-3 pl-5 list-disc flex flex-col gap-3">
                  <li>
                    Maintained and improved Willow SMM product (Node.js,
                    TypeScript) for speed and stability.
                  </li>
                  <li>
                  ...
                  <li>
                    Communicated across teams to gather requirements and deliver
                    on time.
                  </li>
                </ul>
              </div>
              ...
              <div className="w-full lg:w-[30%] shrink-0 flex flex-col gap-4">
                <h3 className="w-fit text-lg pl-2 pr-5 font-medium flex items-center rounded-full border-2 border-h-main/50 bg-h-main/10 text-h-main">
                  <div className="w-10 h-10 flex justify-center items-center">
                    ...
                    >
                      <path
                        d="M64 48c-8.8 0-16 7.2-16 16V448c0 8.8 7.2 16 
            ...
            7.2-16 16-16z"
              ...
              <div className="w-full">
                ...
                <ul className="mt-3 pl-5 list-disc flex flex-col gap-3">
                  <li>
                    Created and maintained DeFi app with React.js, ChakraUI,
                    NestJS, and PostgreSQL.
                  </li>
                  <li>
                    Integrated 300+ wallets and 200+ blockchains for seamless
                    EVM-based interactions.
                  </li>
                  <li>
                    Handled $65M TVL and thousands of daily staking
                    transactions.
                  </li>
                  <li>
                    Launched features like Add Liquidity, Swap, Token Sale, and
            ...
            7.2-16 16-16z"
              ...
              <div className="w-full">
                ...
                <ul className="mt-3 pl-5 list-disc flex flex-col gap-3">
                  <li>
                    Handled 4M+ rows of Amazon Ad campaign data using Django,
                    Jinja2, JavaScript, and MySQL.
                  </li>
                  <li>
                    Built the entire stack, including frontend, backend, and
                    database.
                  </li>
                  <li>
                    Deployed on Heroku with CI/CD, speeding up performance and
                    data access.
                  </li>
                  <li>
                    Analyzed ad campaign trends and flagged data anomalies for
                    business insights.
                  </li>
                </ul>
              </div>
            ...
            7.2-16 16-16z"
              ...
              <div className="w-full">
                ...
                <ul className="mt-3 pl-5 list-disc flex flex-col gap-3">
                  <li>
                    Used Python, Keras, and OpenCV to detect gender (70%
                    accuracy) and age (60% accuracy).
                  </li>
                  <li>
                    Trained on a dataset of 10k+ facial images, exported models
              ...
              <div className="w-full lg:w-[30%] shrink-0 flex flex-col gap-4">
                <h3 className="w-fit text-lg pl-2 pr-5 font-medium flex items-center rounded-full border-2 border-h-main/50 bg-h-main/10 text-h-main">
                  <div className="w-10 h-10 flex justify-center items-center">
                    ...
                    >
                      <path
                        d="M64 48c-8.8 0-16 7.2-16 16V448c0 8.8 
            ...
            7.2-16 16-16z"
              ...
              <div className="w-full">
                ...
                <ul className="mt-3 pl-5 list-disc flex flex-col gap-3">
                  <li>
                    Developed from scratch using Django and JavaScript,
                    integrated WebSockets for chat.
                  </li>
                  <li>
                    Led user feedback cycles, refined features, and fixed bugs
                    swiftly.
                  </li>
                </ul>
              </div>
          ...
          <ul className="w-full mt-8 flex flex-col gap-3">
            ...
            <li className="w-full p-6 flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10 rounded-lg border border-l-c">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  Focused on data science, machine learning with Python, and SQL
                </div>
              </div>
            </li>
            <li className="w-full p-6 flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10 rounded-lg border border-l-c">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div>
                  Learned in-depth about how distributed ledger works and about
